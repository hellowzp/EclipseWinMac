 ...
 * BinaryNode2 recursive routines and merge.
 */
public class BinaryTree<AnyType>
{
    ...
    {
        root = new BinaryNode2<AnyType>( rootItem, null, null );
    }
    ...
    public void merge( AnyType rootItem, BinaryTree<AnyType> t1, BinaryTree<AnyType> t2 )
    {
        if( t1.root == t2.root && t1.root != null )
        {
            ...
            // Allocate new node
        root = new BinaryNode2<AnyType>( rootItem, t1.root, t2.root );
    ...
    public int size( )
    {
        return BinaryNode2.size( root );
    }

    public int height( )
    {
        return BinaryNode2.height( root );
    }

    public BinaryNode2<AnyType> getRoot( )
    {
        return root;
    }
