 ...
 */
final class BinaryNode2<AnyType>
{
    public BinaryNode2( )
    {
        this( null, null, null );
    ...
    public BinaryNode2( AnyType theElement, BinaryNode2<AnyType> lt, BinaryNode2<AnyType> rt )
    {
        element = theElement;
        left    = lt;
        right   = rt;
     ...
     */
    public static <AnyType> int size( BinaryNode2<AnyType> t )
    {
        if( t == null )
            return 0;
        else
     ...
     */
    public static <AnyType> int height( BinaryNode2<AnyType> t )
    {
        if( t == null )
            return -1;
        else
     ...
     */
    public BinaryNode2<AnyType> duplicate( )
    {
        BinaryNode2<AnyType> root = new BinaryNode2<AnyType>( element, null, null );
    ...
    public BinaryNode2<AnyType> getLeft( )
    {
        return left;
    }
    
    public BinaryNode2<AnyType> getRight( )
    {
        return right;
    }
    ...
    public void setLeft( BinaryNode2<AnyType> t )
    {
        left = t;
    }
    
    public void setRight( BinaryNode2<AnyType> t )
    {
        right = t;
    }

    private AnyType             element;
    private BinaryNode2<AnyType> left;
    private BinaryNode2<AnyType> right;
}
