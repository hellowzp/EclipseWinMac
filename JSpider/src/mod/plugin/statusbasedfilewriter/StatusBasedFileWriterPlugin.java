package mod.plugin.statusbasedfilewriter;

import api.event.EventVisitor;
import api.event.JSpiderEvent;
import api.event.engine.*;
import api.event.folder.FolderDiscoveredEvent;
import api.event.folder.FolderRelatedEvent;
import api.event.resource.*;
import api.event.site.*;
import api.model.FetchTriedResource;
import api.model.Resource;
import core.logging.Log;
import core.logging.LogFactory;
import core.util.config.ConfigurationFactory;
import spi.Plugin;
