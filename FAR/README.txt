...
under certain conditions. Instead of starting the default application or the platform
file browser, only an error message will be shown (Linux) or the application will block
(Windows). This is a JVM (Java) bug. Note that neither option is available when running 
